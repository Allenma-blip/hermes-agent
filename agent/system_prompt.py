...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Active behavioral corrections from lessons_pack.md (generated by
    # lesson_injector.sh from lessons.db, updated every 6h).
    try:
        from agent.prompt_builder import load_lessons_pack
        _lessons = load_lessons_pack()
        if _lessons:
            stable_parts.append(_lessons)
    except Exception:
        pass
